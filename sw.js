const CACHE="mihrab-v19-0";
const CORE=["./","./index.html","./styles.css?v=19.0","./app.js?v=19.0","./manifest.webmanifest","./assets/mihrab-logo.svg","./assets/icon.svg","./assets/icon-192.png","./assets/icon-512.png"];
