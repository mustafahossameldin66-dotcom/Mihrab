const CACHE="mihrab-v12";
const CORE=["./","./index.html","./styles.css?v=12","./app.js?v=12","./manifest.webmanifest","./assets/mihrab-logo.svg","./assets/icon.svg","./assets/icon-192.png","./assets/icon-512.png"];
