const CACHE="mihrab-v20-0";
const CORE=["./","./index.html","./styles.css?v=20.0","./app.js?v=20.0","./manifest.webmanifest","./assets/mihrab-logo.svg","./assets/icon.svg","./assets/icon-192.png","./assets/icon-512.png"];
