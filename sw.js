const CACHE="mihrab-v15-1";
const CORE=["./","./index.html","./styles.css?v=13","./app.js?v=13","./manifest.webmanifest","./assets/mihrab-logo.svg","./assets/icon.svg","./assets/icon-192.png","./assets/icon-512.png"];
